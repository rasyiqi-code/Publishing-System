...
export function AdminSidebar({ user, isCollapsed, onToggle, brandName }: AdminSidebarProps) {
    ...
    const settingsItems: NavItem[] = [
        { label: 'Identity', href: '/admin/settings/identity', icon: Settings },
        { label: 'System', href: '/admin/settings/system', icon: Server },
    ];
    ...
    return (
        ...
        >
            ...
            <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-2 no-scrollbar">
                {[...navItems, ...accessControlItems, ...settingsItems].map((item) => (
